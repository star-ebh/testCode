...
public class Test456 {
    public static void main(String[] args) throws Exception {
        ...
        converter.convert(new FileInputStream("E:\\付款导出模板\\output2.docx")).as(DocumentType.DOCX).to(new File("E:\\付款导出模板\\output111111111112.pdf")).as(DocumentType.PDF).execute();
