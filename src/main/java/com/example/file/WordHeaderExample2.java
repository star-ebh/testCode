...
public class WordHeaderExample2 {
...
//            XWPFRun itemRun = itemParagraph.getRuns().get(0);
//            String text = itemRun.getText(0);
////            PDType0Font font = PDType0Font.load(pdfDocument, new File("/usr/share/fonts/msyhl.ttc"));
//            PDType0Font font = PDType0Font.load(pdfDocument, new File("E:\\微软雅黑.ttf"));
...
//        }
//        // 关闭 PDF 页面内容流和 PDF 文档
//        contentStream.close();
//        pdfDocument.save("E:\\test.pdf");
//        document.close();
//        pdfDocument.close();
    }
