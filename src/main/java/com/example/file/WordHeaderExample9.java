...
public class WordHeaderExample9 {
...
//        String pdfName = "E:\\RS-FIN-01-0001 02版 财务管理制度.docx.pdf";
        ...
        String docFileName = "E:\\票据管理办法.doc";
        String fileName = "E:\\票据管理办法.docx";
        String newFileName = "E:\\票据管理办法1111111111111.docx";
        String pdfName = "E:\\票据管理办法.docx.pdf";
        converter.convert(new FileInputStream(docFileName)).as(DocumentType.DOC).to(new File(fileName)).as(DocumentType.DOCX).execute();
